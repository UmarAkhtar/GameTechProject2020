...
int main(int argc, char* argv[]) {
	...
	// ORIGINALLY WAS THINKING TO CALL SCENE MANAGER IN THE SDL EVENT, AND HAVE THAT LOAD SHADERS MODELS, CREATE WINDOW ETC, BUT THEN THAT WOULD CONSTANTLY LOAD EVERYTHING, SO WILL NEED TO 
	// CALL SCENE MANAGER HERE TO STOP THAT. WILL EITHER NEED TO CREATE SOMETHING ELSE FOR THE ACTUAL LOOP OF THE GAME
